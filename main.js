      ...
      html += `
        <div class="match-card ${isLive ? "" : "disabled"}"
          ...
          <div class="match-info">
            ...
            <p class="match-time">${formatTime(data.createdAt)}</p>
          </div>
...
window.openPlayer = async function (id) {
  ...
  try {
    ...
    if (data.player === "fancode") {
      location.href = `player3.html?id=${id}`;
      return;
    }


    /* ======================================================
       PLAYER 2 → ONLY m3u8 + keys
    ====================================================== */
    if (
      url.includes(".m3u8") &&
      data.kid &&
...
/* ======================================================
   PLAYER 1 → m3u8 + iframe/embed links
====================================================== */
if (
  url.includes(".m3u8") ||
  url.includes("embed") ||
